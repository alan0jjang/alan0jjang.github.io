<html>
	...
	if (!$_POST['EventName'] | !$_POST['EventDate'] | !$_POST['Location']) {
		die("<script type='text/javascript'>alert('You did not complete all of the required fields');</script>");
 	}
	
	// now we insert it into the database
 	$insert = "INSERT INTO events (EventName, EventDate, Location)
		VALUES ('".$_POST['EventName']."', '".$_POST['EventDate']."', '".$_POST['Location']."')";
